    ...
    */
    run: async (interaction, client) => {
        ...
        if (interaction.isCommand()) 
        {
            ...
            if ((command.guildOwnerOnly || command.staffOnly) && !guild)
                return interaction.reply({
                    content: `❌ **Le serveur de gestion n'est pas configuré ou introuvable.**`,
                    flags: 64
                });
            ...
            switch (true) {
                case interaction.customId.startsWith('accepter_'):
                    ...
                    client.load(demandes[interaction.customId.split('_')[1]]);
