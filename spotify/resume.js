...
module.exports = {
    name: "resume",
    description: "Reprend la musique actuelle",
    dir: "spotify",
    premium: true,
    /**
     * @param {Client} client
    ...
    */
    run: async (client, message, args) => {
        ...
        if (res.status === 200) return message.edit(`***La musique a été reprise***`);

        return message.edit("***Une erreur s'est produite lors du changement d'état de la musique***");
    }
};